...
If a domain skill is loaded, read its SKILL.md, modules, and references to
understand:
...
Write `.konveyor/spec.md` — a summary of what will be migrated, the approach,
and key decisions applied — following the structure below exactly; do NOT invent
your own headings.
...
Write `.konveyor/implementation.md` — step-by-step migration instructions the
execute stage follows — using the structure below; do NOT invent your own
headings.
