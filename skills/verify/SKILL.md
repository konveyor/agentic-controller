...
5. Run `git add path/to/FixedFile.java && git commit -m "Fix: <describe what was fixed>"`
...
`git add path/to/ChangedFile.java && git commit -m "Verify: build and test results"`
